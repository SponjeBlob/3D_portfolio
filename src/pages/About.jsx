    ...
    <section className="max-container">
      ...
      <ScrollReveal>
        <div>
          ...
          <p className="mt-5 text-white-500 max-w-3xl">
            A 3D Artist, Technical Artist, and Game Designer with a bachelor's degree in Games Design and Art. I enjoy creating immersive experiences through games, animation, and interactive 3D environments. I’m heavily inspired by sci-fi worlds, which also influenced this website.
          </p>
          ...
          >
            <div>
              <img src={linkedinIcon} alt="LinkedIn" className="w-28 h-28 object-contain" />
            </div>
          </a>
          ...
          <a
            ...
            className="hover:scale-110 transition-transform"
          >
            <div className="bg-white p-3 rounded-xl shadow-md w-28 h-28 flex items-center justify-center">
              <img src={resumeIcon} alt="Resume" className="w-16 h-16 object-contain" />
            </div>
          </a>
      ...
      <ScrollReveal>
        <div className="py-16">
          ...
          <p className="mt-5 text-white-500 max-w-3xl">
            Retrace my steps and see how I’ve grown into the 3D artist and game designer I am today.
          </p>
            ...
            {experiences.map((exp) => (
              <div key={exp.title} className="relative mb-8 pl-12">
                ...
                <div className="bg-gray-800 p-4 rounded-xl shadow-lg">
                  ...
                  {exp.company_name && (
                    <p className="text-gray-300 text-sm">{exp.company_name}</p>
                  )}
